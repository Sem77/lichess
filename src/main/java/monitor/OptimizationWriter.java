...
public class OptimizationWriter {
     ...
     * the method creates a PgnGameExtractor object which takes a pgn file in parameter, and give it in parameter to the threads
     ...
     */
    public void saveOptimizedGames(String pathToPgnFile, String month, String year, int numberOfThreads) {
        ...
        try {
            GameExtractorFromPgn gameExt = new GameExtractorFromPgn(pathToPgnFile, directoryToSave);
